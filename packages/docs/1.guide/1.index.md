...
> Quickly integrate PropShow Kit components into your project.

This guide will demonstrate how to quickly integrate a component into your project.

## Step 1: Choose a Component

Browse the component list on the left to find a component that suits your needs. For example, let's choose the **[Copy](/guide/components/copy)** component.
