...
::code-group
:component-source{path="filters/index.ts" filename="index.ts"}
:component-source{path="filters/filter-core.ts" filename="filter-core.ts"}
:component-source{path="filters/filter-core.check.ts" filename="filter-core.check.ts"}
:component-source{path="filters/Filter.vue" filename="Filter.vue"}
:component-source{path="filters/FilterChip.vue" filename="FilterChip.vue"}
:component-source{path="filters/FilterOptionsMenu.vue" filename="FilterOptionsMenu.vue"}
:component-source{path="filters/FiltersContent.vue" filename="FiltersContent.vue"}
::
